...
namespace DataServer
{
    public class LogOutputSocketProtocol : BaseSocketProtocol
    {
            ...
            : base(asyncSocketServer, asyncSocketUserToken)
        {
            ...
            lock (CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr)
            {
                CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr.Add(this);
            }
        ...
        public override void Close()
        {
            lock (CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr)
            {
                CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr.Remove(this);
            }
        }
    ...
    class LogSocketAppender : log4net.Appender.AppenderSkeleton
    {
        ...
        protected override void Append(LoggingEvent loggingEvent)
        {
            ...
            lock (CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr)
            {
                for (int i = 0; i < CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr.Count(); i++)
                {
                    CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr.ElementAt(i).LogFixedBuffer.WriteBuffer(tmpBuffer);
                    CoreService.AsyncSocketSvr.LogOutputSocketProtocolMgr.ElementAt(i).InitiativeSend();
                }
            }
        }
    }
